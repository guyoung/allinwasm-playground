...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1304 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 89, __wbg_adapter_49);
        return addHeapObject(ret);
    };
...
function __wbg_init_memory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:763,maximum:16384,shared:true});
}
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('program_run_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
