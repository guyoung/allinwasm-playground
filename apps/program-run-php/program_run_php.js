...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper3830 = function(arg0, arg1, arg2) {
...
function __wbg_init_memory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:242,maximum:16384,shared:true});
}
...
async function __wbg_init(input, maybe_memory) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('program_run_php_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
